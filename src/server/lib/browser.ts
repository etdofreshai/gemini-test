...
export async function createLoginScreencast(): Promise<{ webSocketDebuggerUrl: string; id: string }> {
  ...
  // Navigate to Google login via CDP WebSocket
  ...
  await new Promise<void>((resolve) => {
    ...
    ws.on("open", () => {
      ws.send(JSON.stringify({
        ...
        params: {
          url: "https://accounts.google.com/ServiceLogin?continue=https://gemini.google.com/app"
        }
      }));
